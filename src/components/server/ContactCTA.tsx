    ...
    <section className="py-16 px-6 md:px-12 bg-green-smoke text-quarter-spanish-white mt-16">
      <div className="max-w-5xl mx-auto text-center">
        <h2 className="text-3xl font-bold mb-4">
          Kurucularımız ile iletişime geçin
        </h2>
        <p className="mb-8 max-w-2xl mx-auto">
          Kurucularımızın çalışmalarıyla ilgileniyorsanız veya olası bir
          işbirliğini görüşmek istiyorsanız, iletişim formumuz aracılığıyla bize
          ulaşın.
        </p>
        <Link
          href="/contact"
