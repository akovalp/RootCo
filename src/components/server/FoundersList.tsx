      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-10 items-start">
          ...
          <div className="md:col-span-2">
            ...
            <div className="mb-6 flex space-x-4">
              {/* //ANCHOR: Mail*/}
              <a href="mailto:psk.selcenserin@gmail.com" className="text-bourbon hover:text-walnut transition-colors" aria-label="Email">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path d="M1.5 8.67v8.58a3 3 0 003 3h15a3 3 0 003-3V8.67l-8.928 5.493a3 3 0 01-3.144 0L1.5 8.67z" />
                  <path d="M22.5 6.908V6.75a3 3 0 00-3-3h-15a3 3 0 00-3 3v.158l9.714 5.978a1.5 1.5 0 001.572 0L22.5 6.908z" />
                </svg>
              ...
              {/* //ANCHOR Insta */}
              <a href="https://www.instagram.com/psk.selcenserin/" className="text-bourbon hover:text-walnut transition-colors" aria-label="Instagram">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              {/* //ANCHOR: LinkedIn */}
              <a href="https://www.linkedin.com/in/selcen-s-7b2aa3152/" className="text-bourbon hover:text-walnut transition-colors" aria-label="LinkedIn">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
