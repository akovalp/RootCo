  ...
  return (
    <nav className="w-full bg-quarter-spanish-white py-4 px-6 md:px-12 flex justify-between items-center shadow-sm">
      ...
      <div className="hidden md:flex space-x-8">
        <Link href="/" className="text-willow-grove hover:text-walnut transition-colors">
          Ana sayfa
        </Link>
        <Link href="/about" className="text-willow-grove hover:text-walnut transition-colors">
          Hakkımızda
        </Link>
        <Link href="/founders" className="text-willow-grove hover:text-walnut transition-colors">
          Kurucular
        </Link>
        <Link href="/contact" className="text-willow-grove hover:text-walnut transition-colors">
          İletişim
        </Link>
      </div>
