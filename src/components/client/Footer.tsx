      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between">
          <div className="mb-6 md:mb-0">
            ...
            Danışmanlık ve destek grupları arayan Türk göçmenler için bir topluluk
          ...
          <div className="grid grid-cols-2 gap-8">
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link href="/" className="text-sm hover:text-grain-brown transition-colors">
                    Anasayfa
                  </Link>
                </li>
                <li>
                  <Link href="/about" className="text-sm hover:text-grain-brown transition-colors">
                    Hakkımızda
                  </Link>
                </li>
                <li>
                  <Link href="/founders" className="text-sm hover:text-grain-brown transition-colors">
                    Kurucular
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link href="/contact" className="text-sm hover:text-grain-brown transition-colors">
                    İletişim
                  </Link>
                </li>
                <li className="text-sm">
                  <a href="mailto:info@rootcommunity.org" className="hover:text-grain-brown transition-colors">
