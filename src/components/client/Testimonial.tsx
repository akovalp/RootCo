...
const testimonials: TestimonialType[] = [
  {
    quote: "Root, yurtdışına taşınma sürecimde vazgeçilmez bir destek sistemi oldu. Danışmanlık ve topluluk büyük fark yarattı.",
    author: "Root topluluk üyesi(İstanbul -> Münih)"
  },
  {
    quote: "Yeni bir ülkeye uyum sağlamak zor olsa da, Root'un rehberliği ile çok daha kolay hale geldi.",
    author: "Root topluluk üyesi (İzmir -> Lisbon)"
  },
  {
    quote: "Türkiyeden göç sürecimde root, benimle aynı deneyimleri yaşayan akranlarım ile tanışmamda oldukça yardımcı oldu.",
    author: "Root topluluk üyesi İIstanbul -> Padova)"
  }
];
          ...
          {testimonials.map((_, index) => (
            <button
              ...
              className={`w-2 h-2 rounded-full transition-all ${
                index === current ? 'bg-bourbon scale-125' : 'bg-battleship-gray bg-opacity-30'
              }`}
